A master copy of the attrib_type table is now kept in the production
database.
...
"master_attrib_type" and should be copied as-is to any new Core or
Core-like database.
...
$Id: README-production_db.txt,v 1.1 2010/11/25 11:19:49 ak4 Exp $
